...
**目前最新版本：v0.1.0 (v1.0 Paper Trading MVP)** — 詳見 [CHANGELOG.md](CHANGELOG.md)。
...
- `tests/` — pytest 測試套件 (371 tests 全綠)
...
├── security/                       DPAPI 加密
├── config/                         兩層設定 (明文 + 加密)
├── data/                           yfinance provider
├── analytics/                      技術指標 (動能 / SMA)
├── strategies/                     BaseStrategy + DualMomentumStrategy
